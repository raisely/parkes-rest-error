...
// adds custom handle to front of error handle stack
function addFormat(formatter) {
	if (typeof formatter !== 'function') {
		return console.warn('Formatter must be of type function');
	}
	errorFormats.unshift(formatter);
	return formatter;
}

module.exports = { addFormat, formatError };
